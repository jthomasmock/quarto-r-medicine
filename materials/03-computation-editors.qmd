...
- Open `quarto-workshop/03-computation/penguin-analysis.qmd`
...
- Open `quarto-workshop/03-authoring/inline-code.qmd`
...
- Open RStudio and `quarto-workshop/03-computations/broken-notebook`
